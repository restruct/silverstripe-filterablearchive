...
namespace Restruct\SilverStripe\FilterableArchive\Extensions {
    ...
    class FilterableHolderControllerExtension extends Extension
    {
        ...
        public function cat()
        {
            ...
            if ( $category ) {
                $this->owner->Items = $category->Items();
        ...
        public function PaginatedItems()
        {
            ...
            else $items->setPageLength(max([ $this->owner->getItems()->count(), 10 ]));
        ...
        public function getArchiveMonth()
        {
            ...
            if ( preg_match("/^[0-9]{1,2}$/", $month) && $month > 0 && $month < 13 && checkdate($month, 01, $this->owner->getArchiveYear()) ) {
                return (int)$month;
            }
        ...
        public function getArchiveDay()
        {
            ...
            // Check that we have a valid date
            if ( preg_match("/^[0-9]{1,2}$/", $day) && checkdate($this->owner->getArchiveMonth(), $day, $this->owner->getArchiveYear()) ) {
                return (int)$day;
            }
        ...
        public function getArchiveDate()
        {
            ...
            if ( $year ) {
                ...
                return DBField::create_field(DBDate::class, $date);
            }
        }
